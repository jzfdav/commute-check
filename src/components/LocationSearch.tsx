...
export function LocationSearch({ label, value, onChange, placeholder }: LocationSearchProps) {
  ...
  return (
    <div className="input-group" style={{ position: 'relative' }} ref={dropdownRef}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        />
        <Search size={16} style={{ position: 'absolute', right: '8px', top: '10px', color: 'var(--text-dim)' }} />
      </div>
